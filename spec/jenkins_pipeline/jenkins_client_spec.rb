...
describe JenkinsPipeline::JenkinsClient do
  ...
  describe "#all_jobs_from" do
    context "a pipeline without a folder" do
      it "request the right path" do
        stub = stub_request(:get, "user:token@jenkins-ci.com/api/json?tree=jobs%5Bname,lastBuild%5Bbuilding%5D,lastCompletedBuild%5Bnumber,duration,timestamp,result,changeSet%5Brevisions%5Brevision%5D%7B0,1%7D%5D%5D%5D").to_return(status: 200, body: "{}")
